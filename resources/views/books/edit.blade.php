...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('books.update', $book) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="cover" class="form-label">Capa (substituir)</label>
                @if($book->cover_image)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $book->cover_image) }}" alt="Capa" style="max-height:150px;">
                    </div>
                @else
                    <div class="mb-2">
                        <img src="{{ asset('images/cover-default.png') }}" alt="Capa padrão" style="max-height:150px;">
                    </div>
                @endif
